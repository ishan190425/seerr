...
const messages = defineMessages('components.Settings.SettingsNetwork', {
  ...
  networksettingsDescription:
    'Configure network settings for your Rathi Studios instance.',
  ...
  trustProxyTip:
    'Allow Rathi Studios to correctly register client IP addresses behind a proxy',
  ...
  forceIpv4FirstTip:
    'Force Rathi Studios to resolve IPv4 addresses first instead of IPv6',
  dnsCache: 'DNS Cache',
  dnsCacheTip:
