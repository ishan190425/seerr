...
const messages = defineMessages('components.Settings.Notifications', {
  ...
  usePublicLogo: 'Use public Rathi Studios logo instead of instance logo',
  usePublicLogoTip:
    'If your Rathi Studios instance is not publicly accessible, enable this option so email clients outside your network can display the image. The image will be pulled from the public GitHub repository.',
